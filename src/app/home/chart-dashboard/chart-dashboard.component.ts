...
export class ChartDashboardComponent {
  ...
  ngOnInit() {
    ...
    localStorage.setItem('pageId', JSON.stringify(1));
    localStorage.setItem('pageHeader', JSON.stringify("Dashboard"));
  }

  title: string = "Correlation between Total Value Across XYZ Region";
  dataSource: any[] = [{
    total1: 9.5,
    total2: 168.8,
    total3: 127.2,
  ...
  //chart 1
  @ViewChild("zoomChart", { static: false }) zoomChart: DxChartComponent;
  stockPrices: any[] = [{
    "Date": "04/23/2013",
    "Open": 808.11,
    "High": 818.00,
  ...
  visualRange: any = { "startValue": "2012-04-22T18:30:00.000Z", "endValue": "2012-06-30T00:30:00.000Z" };
  //{"startValue":"2012-04-22T18:30:00.000Z","endValue":"2012-06-30T00:30:00.000Z"}

  valueChanged(e: any) {
    this.zoomChart.instance.zoomArgument(new Date(e.value[0]), new Date(e.value[1]));
  }

  addCompToSticky() {
    let stickyNoteObj: SharedInterface.IStickyNoteData = <SharedInterface.IStickyNoteData>{
      componentName: "app-chart-dashboard",
